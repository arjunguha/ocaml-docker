...
(* OASIS_START *)
(* DO NOT EDIT (digest: 82ca6ef05c6b30ebe3e01c2a466ab8c6) *)
(*
...
let setup_t =
  {
            ...
            [
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Docker"; "Docker_t"];
                      lib_pack = false;
                      lib_internal_modules = ["Docker_j"];
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "odocker.ml"})
            ];
     ...
     oasis_version = "0.4.4";
     oasis_digest =
       Some "\152\198C\148\221\130\134\185\004A\246\238\028 \173\253";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
