...
(* OASIS_START *)
(* DO NOT EDIT (digest: 8c15e4af2240927e0a9bb1ce070d800f) *)
(*
...
let setup_t =
  {
               ...
               Library
                 ({
                   ...
                   },
                   {
                      lib_modules = ["Docker"];
                      lib_pack = false;
                      lib_internal_modules = ["Docker_t"; "Docker_j"];
     ...
     oasis_version = "0.4.4";
     oasis_digest = Some "Y\147\185m\236\172\005\195\214\228\137=\014\229G\"";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
